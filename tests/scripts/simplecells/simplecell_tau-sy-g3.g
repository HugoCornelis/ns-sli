...
function scale_tau(chan,gate,scale)
        ...
        str tabA = {gate}@"_A"
        str tabB = {gate}@"_B"
	setfield {chan} {tabA}->sy {1.0/scale}
	setfield {chan} {tabB}->sy {1.0/scale}
//        setfield /library/K_hh_tchan X_A-->sy {1.0/scale}
//        setfield /library/K_hh_tchan X_B-->sy {1.0/scale}
end
