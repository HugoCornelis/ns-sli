...
str cellfile = "tests/scripts/test-traub94cell-v0/traub94-soma.p"
str cellpath = "/cell"
...
str outfile = "output/traub94_Vm.out.soma"
...
include tests/scripts/test-traub94cell-v0/protodefs.g
if (debug)
