...
str RUNID = "0000b"        // default ID string for data file names
...
int binary_file = 0 // output file is binary FMT1
...
/* NOTE: The option "binary_file = 0" doesn not work properly under
