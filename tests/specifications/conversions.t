...
',
						  ...
						  {
						   description => "Can we delete the output element (1)?",
						   write => "delete /out",
						  },
						  {
...
",
						  ...
						  {
						   description => "What does this look like in NDF (3), does it include the inject field?",
						   read => '#!neurospacesparse
// -*- NEUROSPACES -*-
...
',
						  ...
						  {
						   description => "Can we create an output element (2)?",
						   write => "create asc_file /out2",
						  },
						  {
						   description => "Can we initialize the output element (2)?",
						   write => 'setfield /out2    filename "/tmp/conversion2.txt" flush 1  leave_open 1 append 1',
						  },
						  {
						   description => "Can we connect the output element with the model?",
						   write => "addmsg       /n/c     /out2       SAVE Vm",
						  },
						  {
						   description => "Can we reset the simulation (2)?",
						   write => "reset",
						  },
						  {
						   description => "Can we run the simulation (2)?",
						   read => "completed",
						   write => "step 0.01 -time",
						  },
						  {
